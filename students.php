            ...
            <div class="main-content row p-2 d-flex align-items-center">
                <div class="col-12 main-content-toolbar d-flex pb-2 justify-content-between align-items-center border-bottom-light">
                    ...
                    <div class="toolbar-left-part">
                        ...
                        <a class="btn btn-primary btn-add-students" title="add student button"  href="students.php?<?=$ACTION_GET_KEY.'='.$ACTION_ADD_FORM_SUBMIT?>">ADD NEW STUDENT</a>
                    </div>
                </div>
                ...
                <div class="row col-12 cards">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card-body d-flex flex-column flex-md-row">
                            ...
                            <span class="col-lg-1 btns">
                                <a class="ic ic-edit btn btn-edit" title="edit button" href="">
                                </a>
                    ...
                    elseif($action==$ACTION_ADD_FORM_SUBMIT){
                        ?>
